...
(function() {
	...
	// Slideshow: slideshow01.
		(function() {
			...
			new slideshowBackground('slideshow01', {
				...
				images: [
					{
						src: 'assets/images/slideshow01-bcdf8229.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Shirt Trade Meetup 2024 -- from Trevor',
					},
					{
						src: 'assets/images/slideshow01-cd0386ae.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: '2024 Shirt Trade Meetup -- from Abby on 2539',
					},
					{
						src: 'assets/images/slideshow01-e4eff678.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: '2023 Shirt Trade Meetup -- from Michael Cao',
					},
				]
			});
	...
	// Initialize "On Visible" animations.
		onvisible.add('#text02', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text01', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text03', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text10', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text26', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text16', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text06', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#buttons04', { style: 'zoom-out', speed: 1000, intensity: 0, threshold: 3, delay: 250, stagger: 125, staggerSelector: ':scope > li', replay: false });
		onvisible.add('#container02', { style: 'fade-right', speed: 1000, intensity: 10, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text32', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text37', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text39', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text04', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text13', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text15', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text14', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text17', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text08', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#container08', { style: 'fade-in', speed: 1000, intensity: 10, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text20', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text22', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text07', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text09', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#buttons03', { style: 'zoom-out', speed: 1000, intensity: 0, threshold: 3, delay: 250, stagger: 125, staggerSelector: ':scope > li', replay: false });
		onvisible.add('#text23', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text25', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text19', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#buttons01', { style: 'zoom-out', speed: 1000, intensity: 0, threshold: 3, delay: 250, stagger: 125, staggerSelector: ':scope > li', replay: false });
		onvisible.add('#text11', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text31', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text24', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text27', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#buttons05', { style: 'zoom-out', speed: 1000, intensity: 0, threshold: 3, delay: 250, stagger: 125, staggerSelector: ':scope > li', replay: false });
		onvisible.add('#text28', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text29', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text34', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text18', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text30', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#buttons06', { style: 'zoom-out', speed: 1000, intensity: 0, threshold: 3, delay: 250, stagger: 125, staggerSelector: ':scope > li', replay: false });
		onvisible.add('#text33', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text35', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text05', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#container06', { style: 'fade-in', speed: 1000, intensity: 10, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text36', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text12', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text21', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text40', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text41', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text42', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text43', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#container01', { style: 'fade-in', speed: 1000, intensity: 10, threshold: 3, delay: 0, replay: false });
